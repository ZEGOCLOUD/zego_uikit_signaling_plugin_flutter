...
import com.zegocloud.uikit.flutter.signal_plugin.zego_uikit_signaling_plugin.R;
import com.zegocloud.uikit.flutter.signal_plugin.zego_uikit_signaling_plugin.StringUtils;
...
public class PluginNotification {
    ...
    public void addLocalNotification(Context context, String title, String body,
                                     ...
                                     String channelID, String soundSource, String iconSource, String notificationIdString) {
        Log.i("signaling plugin", "add Notification, title:" + channelID + ",body:" + body + ",channelId:" + channelID + ",soundSource:" + soundSource + ",iconSource:" + iconSource + ",notificationId:" + notificationIdString);
        ...
        if (0 != iconResourceId) {
            ...
            Log.i("signaling plugin", "icon resource id is not valid, use default icon");
        ...
        try {
            ...
            Log.d("signaling plugin", "convert notification id exception, " + String.format("%s", e.getMessage()));
    ...
    public void createNotificationChannel(Context context, String channelID, String channelName, String soundSource) {
        Log.i("signaling plugin", "create channel, channelId:" + channelID + ",channelName:" + channelName + ",soundSource:" + soundSource);
    ...
    public void dismissAllNotifications(Context context) {
        Log.i("signaling plugin", "dismiss all notifications");
    ...
    public Uri retrieveSoundResourceUri(Context context, String soundSource) {
        ...
        if (StringUtils.isNullOrEmpty(soundSource)) {
            Log.i("signaling plugin", "source resource id is null or empty, use default ringtone");
            ...
            if (soundResourceId > 0) {
                ...
                Log.i("signaling plugin", "source resource id is not valid, use default ringtone");
                uri = RingtoneManager.getDefaultUri(RingtoneManager.TYPE_RINGTONE);
            }
        }
        return uri;
    ...
    public void requestDismissKeyguard(Context context, Activity activity) {
        Log.d("signaling plugin", "request dismiss keyguard");
    ...
    public void activeAppToForeground(Context context) {
        Log.d("signaling plugin", "active app to foreground");
...
//            Log.d("signaling plugin", "app task null");
//            return;
//        }
//
